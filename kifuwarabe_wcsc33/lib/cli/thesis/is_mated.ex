    ...
    is_suicide_move =
      cond do
        ...
        |> adjacent(
          ...
          src_sq,
          :north_east_of,
          is_effect_in_north_east?,
          true,
          is_effect_in_north_east_2?
        ) ->
          true
        ...
        # ──＞
        pos
        |> adjacent(king_turn, src_sq, :east_of, is_effect_in_east?, true, is_effect_in_east_2?) ->
          true
        ...
        |> adjacent(
          ...
          src_sq,
          :south_east_of,
          is_effect_in_south_east?,
          true,
          is_effect_in_south_east_2?
        ) ->
          true
        ...
        # ＜──
        pos
        |> adjacent(king_turn, src_sq, :west_of, is_effect_in_east?, true, is_effect_in_east_2?) ->
          true
